# Generated by Django 3.1.4 on 2021-10-29 17:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('developers', models.ManyToManyField(null=True, to='core.Developer')),
                ('features', models.ManyToManyField(null=True, to='core.Feature')),
                ('genres', models.ManyToManyField(null=True, to='core.Genre')),
                ('pictures', models.ManyToManyField(null=True, to='core.Picture')),
                ('prices', models.ManyToManyField(null=True, to='core.Price')),
                ('publishers', models.ManyToManyField(null=True, to='core.Publisher')),
                ('specification', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.specification')),
                ('videos', models.ManyToManyField(null=True, to='core.Video')),
            ],
        ),
    ]
